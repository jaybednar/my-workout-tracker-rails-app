...
EXERCISES = [
	{name: "Barbell Flat Bench Press", bodypart: "Chest", sets: 3, reps: 10},
...
# 	{name: "Pullovers", bodypart: "Chest"},
	...
	{name: "Barbell Military Press", bodypart: "Shoulders", sets: 3, reps: 10},
...
# 	{name: "Reverse Cable Crossovers ", bodypart: "Shoulders"},
	...
	{name: "Pulldowns (Wide, Under, Vbar, comfort, 1-arm)", bodypart: "Back", sets: 3, reps: 10},
...
# 	{name: "Cable row(under) ", bodypart: "Back"},
	...
	{name: "Barbell Curls", bodypart: "Arms", sets: 3, reps: 10},
